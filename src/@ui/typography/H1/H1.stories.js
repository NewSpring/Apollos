  ...
  .add('Border Box – platform testing', () => {
    ...
    return (
      <ScrollView>
        ...
        <H1 style={border}>{'"Do all the good you can. By all the means you can. In all the ways you can. In all the places you can. At all the times you can. To all the people you can. As long as ever you can." ― John Wesley'}</H1>
      </ScrollView>
    );
  });
